...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <fieldset>
        ...
        <div class="control-group">
            <asp:Label runat="server" CssClass="control-label" AssociatedControlID="UserName" Text="User Name" ></asp:Label>
            <div class="controls">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="UserName" CssClass="badge badge-important"
                     ErrorMessage="The user name field is required." />
            </div>
        </div>
        <div class="control-group">
            <asp:Label runat="server" CssClass="control-label" AssociatedControlID="Email" Text="Email address"></asp:Label>
            <div class="controls">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="Email" CssClass="badge badge-important"
